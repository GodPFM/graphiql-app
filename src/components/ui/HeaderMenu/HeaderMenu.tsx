...
const HeaderMenu = (props: IProps) => (
  ...
  >
    <Button
      variant="text"
      className="font-SourceSansPro font-semibold text-white leading-5 normal-case text-[14px] hover:bg-[#003D5B]"
    ...
    <Button
      variant="contained"
      className="bg-color-dark-blue font-semibold h-[28px] normal-case text-[14px] hover:bg-[#003D5B]"
      onClick={props.closeBurger}
    >
      Log in
    </Button>
